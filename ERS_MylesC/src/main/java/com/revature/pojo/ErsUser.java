...
public class ErsUser {
	...
	public ErsUser() {}
	public ErsUser(int user_id, String username, String password, String firstname, String lastname,
					String email, int role_id, String user_role) {
	...
	public String toString() {
		return "ErsUser [user_id=" + user_id + ", username=" + username + ", password=" + password + ", firstname="
				+ firstname + ", lastname=" + lastname + ", email=" + email + ", role_id=" + role_id + ", user_role="
				+ user_role + "]";
	}
